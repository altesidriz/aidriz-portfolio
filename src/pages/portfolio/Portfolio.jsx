...
const items = [
  {
    ...
    desc: "A clone web site of one of my favourite games Blade and Soul, where you can register upload pictures, comment on blog page, and purchase in game items (note that this project is not affiliated with or endorsed by the official Blade & Soul game or NCSOFT.). Use mail:altes@gmail.com, password: 123456 to open the admin functionalities.",
  ...
  },
  {
    ...
    desc: "Website Application where ou can find cars check prices and contact with offerer. Also you can be an offerer and upload your own car to sell it. (The project is still in development and not yet complete.)",
    link: '#'
  }
];
